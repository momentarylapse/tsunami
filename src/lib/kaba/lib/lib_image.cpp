	...
	add_class(TypeImage);
		...
		add_class(TypeBasePainter);
			...
			class_add_func_virtual("draw_polygon", TypeVoid, &Painter::draw_polygon, Flags::CONST);
				func_add_param("p", TypeComplexList);
			class_add_func_virtual("draw_rect", TypeVoid, mf((void (Painter::*) (float,float,float,float))&Painter::draw_rect), Flags::CONST);
				func_add_param("x", TypeFloat32);
				func_add_param("y", TypeFloat32);
				func_add_param("w", TypeFloat32);
				func_add_param("h", TypeFloat32);
			class_add_func_virtual("draw_rect", TypeVoid, mf((void (Painter::*) (const rect&))&Painter::draw_rect), Flags::CONST);
				func_add_param("r", TypeRect);
