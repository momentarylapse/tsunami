...
void SIAddPackageHui()
{
	...
	add_class(TypeHuiWindow);
		...
		class_add_func("__init__",		TypeVoid,		mf(&HuiWindow::__init_ext__), FLAG_OVERWRITE);
			func_add_param("title",		TypeString);
			func_add_param("x",		TypeInt);
			func_add_param("y",		TypeInt);
			func_add_param("width",		TypeInt);
			func_add_param("height",		TypeInt);
		class_add_func_virtual("__delete__",		TypeVoid,		mf(&HuiWindow::__delete__), FLAG_OVERWRITE);
	...
	add_class(TypeHuiNixWindow);
		...
		class_add_func("__init__",		TypeVoid,		mf(&HuiNixWindow::__init_ext__), FLAG_OVERWRITE);
			func_add_param("title",		TypeString);
			func_add_param("x",		TypeInt);
			func_add_param("y",		TypeInt);
			func_add_param("width",		TypeInt);
	...
	add_class(TypeHuiDialog);
		...
		class_add_func("__init__",		TypeVoid,		mf(&HuiDialog::__init_ext__), FLAG_OVERWRITE);
			func_add_param("title",		TypeString);
			func_add_param("width",		TypeInt);
			func_add_param("height",		TypeInt);
	...
	add_class(TypeHuiFixedDialog);
		...
		class_add_func("__init__",		TypeVoid,		mf(&HuiFixedDialog::__init_ext__), FLAG_OVERWRITE);
			func_add_param("title",		TypeString);
			func_add_param("width",		TypeInt);
			func_add_param("height",		TypeInt);
			func_add_param("root",		TypeHuiWindowP);
