...
void SIAddPackageHui()
{
	...
	add_class(TypeHuiMenu);
		...
		add_class(TypeHuiPanel);
			...
			class_add_func("eventO",						TypeVoid,		mf(&HuiPanel::_kaba_eventO));
				func_add_param("id",			TypeString);
				func_add_param("handler",		TypePointer);
				func_add_param("func",			TypePointer);
			class_add_func("eventX",						TypeVoid,		mf(&HuiPanel::_kaba_eventX));
				func_add_param("id",			TypeString);
				func_add_param("msg",			TypeString);
				func_add_param("func",			TypePointer);
			class_add_func("eventOX",						TypeVoid,		mf(&HuiPanel::_kaba_eventOX));
				func_add_param("id",			TypeString);
				func_add_param("msg",			TypeString);
				func_add_param("handler",		TypePointer);
				func_add_param("func",			TypePointer);
