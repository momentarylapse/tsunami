...
void SIAddPackageHui() {
	...
	add_class(TypeHuiMenu);
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, hui_p(mf(&hui::Menu::__init__)));
		class_add_func("popup", TypeVoid, hui_p(mf(&hui::Menu::open_popup)));
			func_add_param("p", TypeHuiPanel);
		class_add_func("add", TypeVoid, hui_p(mf(&hui::Menu::add)));
			func_add_param("name", TypeString);
			func_add_param("id", TypeString);
		class_add_func("add_with_image", TypeVoid, hui_p(mf(&hui::Menu::add_with_image)));
			func_add_param("name", TypeString);
			func_add_param("image", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_checkable", TypeVoid, hui_p(mf(&hui::Menu::add_checkable)));
			func_add_param("name", TypeString);
			func_add_param("id", TypeString);
		class_add_func("add_separator", TypeVoid, hui_p(mf(&hui::Menu::add_separator)));
		class_add_func("add_sub_menu", TypeVoid, hui_p(mf(&hui::Menu::add_sub_menu)));
			func_add_param("name", TypeString);
			func_add_param("id", TypeString);
			func_add_param("sub_menu", TypeHuiMenu);
		class_add_func("enable", TypeVoid, hui_p(mf(&hui::Menu::enable)));
			func_add_param("id", TypeString);
			func_add_param("enabled", TypeBool);
		class_add_func("check", TypeVoid, hui_p(mf(&hui::Menu::check)));
			func_add_param("id", TypeString);
			func_add_param("checked", TypeBool);

	add_class(TypeHuiToolbar);
		class_derive_from(TypeObject, false, true);
		class_add_func("set_by_id", TypeVoid, hui_p(mf(&hui::Toolbar::set_by_id)));
			func_add_param("id", TypeString);
		class_add_func("from_source", TypeVoid, hui_p(mf(&hui::Toolbar::from_source)));
			func_add_param("source", TypeString);

	add_class(TypeHuiPanel);
		class_derive_from(TypeObject, false, true);
		class_add_element("win", TypeHuiWindowP, GetDAPanel(win));
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, hui_p(mf(&hui::Panel::__init__)), Flags::OVERRIDE);
		class_add_func_virtual(IDENTIFIER_FUNC_DELETE, TypeVoid, hui_p(mf(&hui::Panel::__delete__)), Flags::OVERRIDE);
		class_add_func("set_border_width", TypeVoid, hui_p(mf(&hui::Panel::set_border_width)));
			func_add_param("width", TypeInt);
		class_add_func("set_decimals", TypeVoid, hui_p(mf(&hui::Panel::set_decimals)));
			func_add_param("decimals", TypeInt);
		class_add_func("activate", TypeVoid, hui_p(mf(&hui::Panel::activate)));
			func_add_param("id", TypeString);
		class_add_func("is_active", TypeVoid, hui_p(mf(&hui::Panel::is_active)));
			func_add_param("id", TypeString);
		class_add_func("from_source", TypeVoid, hui_p(mf(&hui::Panel::from_source)));
			func_add_param("source", TypeString);
		class_add_func("add_button", TypeVoid, hui_p(mf(&hui::Panel::add_button)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_def_button", TypeVoid, hui_p(mf(&hui::Panel::add_def_button)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_check_box", TypeVoid, hui_p(mf(&hui::Panel::add_check_box)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_label", TypeVoid, hui_p(mf(&hui::Panel::add_label)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_edit", TypeVoid, hui_p(mf(&hui::Panel::add_edit)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_multiline_edit", TypeVoid, hui_p(mf(&hui::Panel::add_multiline_edit)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_group", TypeVoid, hui_p(mf(&hui::Panel::add_group)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_combo_box", TypeVoid, hui_p(mf(&hui::Panel::add_combo_box)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_tab_control", TypeVoid, hui_p(mf(&hui::Panel::add_tab_control)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("set_target", TypeVoid, hui_p(mf(&hui::Panel::set_target)));
			func_add_param("id", TypeString);
		class_add_func("add_list_view", TypeVoid, hui_p(mf(&hui::Panel::add_list_view)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_tree_view", TypeVoid, hui_p(mf(&hui::Panel::add_tree_view)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_icon_view", TypeVoid, hui_p(mf(&hui::Panel::add_icon_view)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_progress_bar", TypeVoid, hui_p(mf(&hui::Panel::add_progress_bar)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_slider", TypeVoid, hui_p(mf(&hui::Panel::add_slider)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_drawing_area", TypeVoid, hui_p(mf(&hui::Panel::add_drawing_area)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_grid", TypeVoid, hui_p(mf(&hui::Panel::add_grid)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_spin_button", TypeVoid, hui_p(mf(&hui::Panel::add_spin_button)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_radio_button", TypeVoid, hui_p(mf(&hui::Panel::add_radio_button)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_scroller", TypeVoid, hui_p(mf(&hui::Panel::add_scroller)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_expander", TypeVoid, hui_p(mf(&hui::Panel::add_expander)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_separator", TypeVoid, hui_p(mf(&hui::Panel::add_separator)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_paned", TypeVoid, hui_p(mf(&hui::Panel::add_paned)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("add_revealer", TypeVoid, hui_p(mf(&hui::Panel::add_revealer)));
			func_add_param("title", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
			func_add_param("id", TypeString);
		class_add_func("embed", TypeVoid, hui_p(mf(&hui::Panel::embed)));
			func_add_param("panel", TypeHuiPanel);
			func_add_param("id", TypeString);
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
		class_add_func("set_string", TypeVoid, hui_p(mf(&hui::Panel::set_string)));
			func_add_param("id", TypeString);
			func_add_param("s", TypeString);
		class_add_func("add_string", TypeVoid, hui_p(mf(&hui::Panel::add_string)));
			func_add_param("id", TypeString);
			func_add_param("s", TypeString);
		class_add_func("get_string", TypeString, hui_p(mf(&hui::Panel::get_string)));
			func_add_param("id", TypeString);
		class_add_func("set_float", TypeVoid, hui_p(mf(&hui::Panel::set_float)));
			func_add_param("id", TypeString);
			func_add_param("f", TypeFloat32);
		class_add_func("get_float", TypeFloat32, hui_p(mf(&hui::Panel::get_float)));
			func_add_param("id", TypeString);
		class_add_func("enable", TypeVoid, hui_p(mf(&hui::Panel::enable)));
			func_add_param("id", TypeString);
			func_add_param("enabled", TypeBool);
		class_add_func("is_enabled", TypeBool, hui_p(mf(&hui::Panel::is_enabled)));
			func_add_param("id", TypeString);
		class_add_func("check", TypeVoid, hui_p(mf(&hui::Panel::check)));
			func_add_param("id", TypeString);
			func_add_param("checked", TypeBool);
		class_add_func("is_checked", TypeBool, hui_p(mf(&hui::Panel::is_checked)));
			func_add_param("id", TypeString);
		class_add_func("hide_control", TypeVoid, hui_p(mf(&hui::Panel::hide_control)));
			func_add_param("id", TypeString);
			func_add_param("hide", TypeBool);
		class_add_func("delete_control", TypeVoid, hui_p(mf(&hui::Panel::delete_control)));
			func_add_param("id", TypeString);
		class_add_func("get_int", TypeInt, hui_p(mf(&hui::Panel::get_int)));
			func_add_param("id", TypeString);
		class_add_func("get_selection", TypeIntList, hui_p(mf(&hui::Panel::get_selection)));
			func_add_param("id", TypeString);
		class_add_func("set_int", TypeVoid, hui_p(mf(&hui::Panel::set_int)));
			func_add_param("id", TypeString);
			func_add_param("i", TypeInt);
		class_add_func("set_image", TypeVoid, hui_p(mf(&hui::Panel::set_image)));
			func_add_param("id", TypeString);
			func_add_param("image", TypeString);
		class_add_func("get_cell", TypeString, hui_p(mf(&hui::Panel::get_cell)));
			func_add_param("id", TypeString);
			func_add_param("row", TypeInt);
			func_add_param("column", TypeInt);
		class_add_func("set_cell", TypeVoid, hui_p(mf(&hui::Panel::set_cell)));
			func_add_param("id", TypeString);
			func_add_param("row", TypeInt);
			func_add_param("column", TypeInt);
			func_add_param("s", TypeString);
		class_add_func("set_options", TypeVoid, hui_p(mf(&hui::Panel::set_options)));
			func_add_param("id", TypeString);
			func_add_param("options", TypeString);
		class_add_func("reset", TypeVoid, hui_p(mf(&hui::Panel::reset)));
			func_add_param("id", TypeString);
		class_add_func("redraw", TypeVoid, hui_p(mf(&hui::Panel::redraw)));
			func_add_param("id", TypeString);
		class_add_func("reveal", TypeVoid, hui_p(mf(&hui::Panel::reveal)));
			func_add_param("id", TypeString);
			func_add_param("reveal", TypeBool);
		class_add_func("is_revealed", TypeBool, hui_p(mf(&hui::Panel::is_revealed)));
			func_add_param("id", TypeString);
		class_add_func("event", TypeInt, hui_p(mf(&KabaPanelWrapper::_kaba_event)));
			func_add_param("id", TypeString);
			func_add_param("func", TypeCallback);
		class_add_func("event_o", TypeInt, hui_p(mf(&KabaPanelWrapper::_kaba_event_o)));
			func_add_param("id", TypeString);
			func_add_param("handler", TypeObject);
			func_add_param("func", TypeCallback);
		class_add_func("event_x", TypeInt, hui_p(mf(&KabaPanelWrapper::_kaba_event_x)));
			func_add_param("id", TypeString);
		...
		class_add_func("event_ox", TypeInt, hui_p(mf(&KabaPanelWrapper::_kaba_event_ox)));
			func_add_param("id", TypeString);
			func_add_param("msg", TypeString);
			func_add_param("handler", TypeObject);
			func_add_param("func", TypeCallback);
		class_add_func("event_ox", TypeInt, hui_p(mf(&KabaPanelWrapper::_kaba_event_ox)));
			...
			func_add_param("handler", TypeObject);
			func_add_param("func", TypeCallbackP);
		class_add_func("remove_event_handler", TypeVoid, hui_p(mf(&hui::Panel::remove_event_handler)));
	...
	add_class(TypeHuiWindow);
		...
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, hui_p(mf(&hui::Window::__init_ext__)), Flags::OVERRIDE);
			func_add_param("title", TypeString);
			func_add_param("width", TypeInt);
			func_add_param("height", TypeInt);
		class_add_func_virtual(IDENTIFIER_FUNC_DELETE, TypeVoid, hui_p(mf(&hui::Window::__delete__)), Flags::OVERRIDE);
		class_add_func("run", TypeVoid, hui_p(mf(&hui::Window::run)));
		class_add_func("destroy", TypeVoid, hui_p(mf(&hui::Window::request_destroy)));
		class_add_func("show", TypeVoid, hui_p(mf(&hui::Window::show)));
		class_add_func("hide", TypeVoid, hui_p(mf(&hui::Window::hide)));

		class_add_func("set_menu", TypeVoid, hui_p(mf(&hui::Window::set_menu)));
			func_add_param("menu", TypeHuiMenu);
		class_add_func("toolbar", TypeHuiToolbarP, hui_p(mf(&hui::Window::get_toolbar)), Flags::SELFREF);
			func_add_param("index", TypeInt);
		class_add_func("set_maximized", TypeVoid, hui_p(mf(&hui::Window::set_maximized)));
			func_add_param("max", TypeBool);
		class_add_func("is_maximized", TypeBool, hui_p(mf(&hui::Window::is_maximized)));
		class_add_func("is_minimized", TypeBool, hui_p(mf(&hui::Window::is_minimized)));
		class_add_func("set_id", TypeVoid, hui_p(mf(&hui::Window::set_id)));
			func_add_param("id", TypeInt);
		class_add_func("set_fullscreen", TypeVoid, hui_p(mf(&hui::Window::set_fullscreen)));
			func_add_param("fullscreen",TypeBool);
		class_add_func("set_title", TypeVoid, hui_p(mf(&hui::Window::set_title)));
			func_add_param("title", TypeString);
		class_add_func("set_position", TypeVoid, hui_p(mf(&hui::Window::set_position)));
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
	...
	//add_func("getInterior", TypeIRect, 1, TypePointer,"win");
		class_add_func("set_cursor_pos", TypeVoid, hui_p(mf(&hui::Window::set_cursor_pos)));
			func_add_param("x", TypeInt);
			func_add_param("y", TypeInt);
		class_add_func("get_mouse", TypeBool, hui_p(mf(&hui::Window::get_mouse)));
			func_add_param("x", TypeIntPs);
			func_add_param("y", TypeIntPs);
			func_add_param("button", TypeInt);
			func_add_param("change", TypeInt);
		class_add_func("get_key", TypeBool, hui_p(mf(&hui::Window::get_key)));
			func_add_param("key", TypeInt);
		class_add_func_virtual("on_mouse_move", TypeVoid, hui_p(mf(&hui::Window::on_mouse_move)));
		class_add_func_virtual("on_mouse_wheel", TypeVoid, hui_p(mf(&hui::Window::on_mouse_wheel)));
		class_add_func_virtual("on_left_button_down", TypeVoid, hui_p(mf(&hui::Window::on_left_button_down)));
		class_add_func_virtual("on_middle_button_down", TypeVoid, hui_p(mf(&hui::Window::on_middle_button_down)));
		class_add_func_virtual("on_right_button_down", TypeVoid, hui_p(mf(&hui::Window::on_right_button_down)));
		class_add_func_virtual("on_left_button_up", TypeVoid, hui_p(mf(&hui::Window::on_left_button_up)));
		class_add_func_virtual("on_middle_button_up", TypeVoid, hui_p(mf(&hui::Window::on_middle_button_up)));
		class_add_func_virtual("on_right_button_up", TypeVoid, hui_p(mf(&hui::Window::on_right_button_up)));
		class_add_func_virtual("on_double_click", TypeVoid, hui_p(mf(&hui::Window::on_double_click)));
		class_add_func_virtual("on_close_request", TypeVoid, hui_p(mf(&hui::Window::on_close_request)));
		class_add_func_virtual("on_key_down", TypeVoid, hui_p(mf(&hui::Window::on_key_down)));
		class_add_func_virtual("on_key_up", TypeVoid, hui_p(mf(&hui::Window::on_key_up)));
		class_add_func_virtual("on_draw", TypeVoid, hui_p(mf(&hui::Window::on_draw)));
	...
	add_class(TypeHuiNixWindow);
		...
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, hui_p(mf(&hui::NixWindow::__init_ext__)), Flags::OVERRIDE);
			func_add_param("title", TypeString);
			func_add_param("width", TypeInt);
			func_add_param("height", TypeInt);
		class_add_func_virtual(IDENTIFIER_FUNC_DELETE, TypeVoid, hui_p(mf(&hui::Window::__delete__)), Flags::OVERRIDE);
	...
	add_class(TypeHuiDialog);
		class_derive_from(TypeHuiWindow, false, true);
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, hui_p(mf(&hui::Dialog::__init_ext__)), Flags::OVERRIDE);
			func_add_param("title", TypeString);
			func_add_param("width", TypeInt);
			func_add_param("height", TypeInt);
