...
#include <module/synthesizer/EnvelopeADSR.h>
...
#include <view/audioview/ViewPort.h>
...
void PluginManager::export_kaba_package_tsunami(kaba::IExporter* ext) {
	...
	ext->link_class_func("Module.OutPort._init_audio", &kaba::generic_init_ext<AudioOutPort, Module*, const string&>);
	ext->link_class_func("Module.OutPort._init_midi", &kaba::generic_init_ext<MidiOutPort, Module*, const string&>);
	ext->link_class_func("Module.OutPort._init_beats", &kaba::generic_init_ext<BeatsOutPort, Module*, const string&>);
	...
	ext->link_class_func("Module.InPort._init_audio", &kaba::generic_init_ext<AudioInPort, Module*, const string&>);
	ext->link_class_func("Module.InPort._init_midi", &kaba::generic_init_ext<MidiInPort, Module*, const string&>);
	ext->link_class_func("Module.InPort._init_beats", &kaba::generic_init_ext<BeatsInPort, Module*, const string&>);
...

	{
		...
		ext->link_class_func("AudioInput.__init__", &kaba::generic_init_ext<AudioInput, Session*>);
...

	{
		...
		ext->link_class_func("AudioOutput.__init__", &kaba::generic_init_ext<AudioOutput, Session*>);
...

	{
		...
		ext->link_class_func("MidiInput.__init__", &kaba::generic_init_ext<MidiInput, Session*>);
