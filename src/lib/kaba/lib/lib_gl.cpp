...
void SIAddPackageGl(Context *c) {
	...
	add_class(TypeContext);
		...
		class_add_func("load_shader", TypeShaderXfer, gl_p(&__ContextLoadShader), Flags::RAISES_EXCEPTIONS | Flags::MUTABLE);
			func_add_param("filename", TypePath);
		class_add_func("create_shader", TypeShaderXfer, gl_p(&__ContextCreateShader), Flags::RAISES_EXCEPTIONS | Flags::MUTABLE);
