...
public:
	...
	static base::result<Image> load(const Path &filename);
	base::result_void _cdecl _load(const Path &filename);
	base::result_void _cdecl _load_flipped(const Path &filename);
